...
\vspace*{3pt}
	\area{Selected Coursework:}{Introduction to Operating Systems $\cdot$ Computer Vision $\cdot$ Introduction to Machine Learning $\cdot$ Web Systems $\cdot$ Database Management Systems $\cdot$ Data Structures \& Algorithms $\cdot$ Advanced Calculus $\cdot$ Introduction to Artificial Intelligence}
...
{Computer Science Instructor}{June 2017 - August 2018}
	\begin{achievements}
		\item Instructed class of over 30 high schoolers on advanced concepts of C/C++ programming and circuit design
		\item Worked with other instructors to implement an educational syllabus for future students as a step by step process on how to get started in computer science, electrical engineering, and mechanical engineering
		\item Led test-driven development to reduce development time by about 25\%
		\item Updated project resources to be better understood by students such as converting to conda as a package management system and adding comments in provided source code
		\item Guided students in arduino and Raspberry Pi development leading to successful implementation of their personal projects, such as an drum sequencer, red tracking robot, and a bluetooth controlled 3D hand
